...
export default function rootReducer (state = initialState, action){
    ...
    switch(action.type){
        ...
        case "FILTER_BY_TEMPERAMENTS":
            ...
            const filterByTemp = action.payload === "all" ? allDogsTemp : allDogsTemp.filter(el => {
        ...
        case "ORDER_BY_NAME" :
            const sortedDogsByName = action.payload === "asc" 
        ...
        case "ORDER_BY_WEIGHT" :
            const sortedDogsByWeight = action.payload === "asc"
            ? state.dogs.sort(function (a, b){
